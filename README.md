...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c9fdeb3a-2f9f-4011-b3a4-5cc86212a011
```

> `c9fdeb3a-2f9f-4011-b3a4-5cc86212a011` is the password of the certificate, you can change it to any password you want.
